...
<div class="div3">
    ...
    <table class="table2">
        <tr>
            ...
            <td class="tdBottom"><input type="text" class="input1" name="departId" required="required"></td>
        </tr>   
        <tr>
            <td class="tdTop">院系名称 / DepartName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="departName" required="required"></td>
        </tr>               
    </table>
...
$("#form1").submit(function(e){
    $.ajax({
		...
		type : "post",
		url : '<c:url value="DepartServlet/insertDepart" />'  
	}); 
});
function goBack(){
	$.ajax({
