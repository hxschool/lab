...
<div class="div3">
    ...
    <table class="table2">
        <tr>
            ...
            <td class="tdBottom"><input type="text" class="input1" name="equtypeId" required="required"></td>
        </tr> 
         <tr>
            <td class="tdTop">设备图片 / EquipmentImg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="file" class="input1" name="file" style="border:1px solid rgb(169, 169, 169);"></td>
        </tr>     
        <tr>
            <td class="tdTop">设备名称 / EquipmentName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="number" class="input1" name="equtypeName" required="required"></td>
        </tr>               
    </table>
...
$("#form1").submit(function(e){
    ...
    $.ajax({
		...
		type : "post",
		url : '<c:url value="Equi_typeServlet/addEquipment" />'  
	}); 
});
function goBack(){
	$.ajax({
