...
<div class="div3">
    ...
    <table class="table2">
        <tr>
            ...
            <td class="tdBottom"><input type="text" class="input1" name="funtypeId" required="required"></td>
        </tr> 
         <tr>
            <td class="tdTop">家具图片 / furnitureImg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="file" class="input1" name="file" style="border:1px solid rgb(169, 169, 169);"></td>
        </tr>     
        <tr>
            <td class="tdTop">家具名称 / furnitureName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="funtypeName" required="required"></td>
        </tr>               
    </table>
...
$("#form1").submit(function(e){
    ...
    $.ajax({
		...
		type : "post",
		url : '<c:url value="Furn_typeServlet/addFurniture_type" />'  
	}); 
});
function goBack(){
	$.ajax({
