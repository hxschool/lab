	...
	<div class="div3">
		...
		<div
			...
			<img src="img/xiaofuhao.png"
				style="width: 22px; height: 22px; margin-bottom: -5px">实验室设备总览表
		</div>
		<table class="table2">
			<tr style="border-bottom: 1px solid #dedede;">
				...
				<td
					style="width: 15%; height: 40px; color: #000000; font-weight: 700">设备类型数</td>
				<td
					style="width: 15%; height: 40px; color: #000000; font-weight: 700">设备总数</td>		
				<td
...
function fenpage(currentPage,totalPages) {
	...
	$.ajax({
		...
		type : "get",
		url : '<c:url value="LaborAndEqu/findAllEqu" />'  
	});
	}
}
</script>
