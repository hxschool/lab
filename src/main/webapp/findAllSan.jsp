	...
	<div class="div3">
		...
		<div
			...
			<img src="img/xiaofuhao.png"
				style="width: 22px; height: 22px; margin-bottom: -5px">实验室评分总览表
		</div>
		<table class="table2">
			<tr style="border-bottom: 1px solid #dedede;">
				...
				<td
					style="width: 15%; height: 40px; color: #000000; font-weight: 700">最新分</td>
				<td
					style="width: 15%; height: 40px; color: #000000; font-weight: 700">平均分</td>		
				<td
					style="width: 20%; height: 40px; color: #000000; font-weight: 700">问题描述</td>
			</tr>
			<c:forEach items="${laborAndSans }" var="laborAndSan" varStatus="status">
				<tr class="table2Tr" style="border-bottom: 1px solid #dedede;">
					...
					<td style="width: 20%; height: 40px; color: #318dcf;">${laborAndSan.labName}</td>
					<td style="width: 15%; height: 40px; color: #318dcf;">${laborAndSan.labRoom}</td>
					<td style="width: 15%; height: 40px; color: red;">${laborAndSan.sanFen}</td>
					<td style="width: 15%; height: 40px; color: red;">${laborAndSan.sanAvgfen }</td>
					<td
						style="width: 20%; height: 40px; color: #000000; font-weight: 700;">
						<a href="javascript:void(0)" onclick="information(${laborAndSan.sanFen})"><div
							class="buttonImg">问题描述</div></a>
					</td>
				</tr>
			</c:forEach>
		</table>
