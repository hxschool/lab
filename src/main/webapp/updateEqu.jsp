...
<div class="div3">
    ...
    <div  style="font-size: 17px;color:#ff8052;border-bottom: 1px solid #f1f2f3;margin-left: 2%;
        ...
        <img  src="img/xiaofuhao.png" style="width: 22px;height: 22px;margin-bottom: -5px">修改实验室设备
    </div>
    <form action="laborServlet" method="post" id="form1" >
    <input type="hidden" name="equOid" value="${Equipment.equOid}">
    <table class="table2">
        <tr>
            <td class="tdTop">设备编号 / number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="equId" value="${Equipment.equId}"></td>
        </tr> 
         <tr>
            <td class="tdTop">设备数量 / EquipmentImg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom">
            <input type="text" class="input1" name="equCount" value="${Equipment.equCount}"></td>
        </tr>     
        <tr>
         ...
         <tr>
            ...
            <td class="tdBottom">
                <select name="etypeId" class="input1" >
						...
						<c:if test="${Equipment.etypeId eq Funtype.equtypeId }">
...
function updateequ(labId){
	 $.ajax({
			...
			type : "post",
			url : '<c:url value="LaborAndEquServlet/updateEqu" />'  
		}); 
}
