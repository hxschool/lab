...
<div class="div3">
    ...
    <input type="hidden" name="equtypeOid" value="${ Equ_type.equtypeOid }">
    <table class="table2">
        <tr>
            <td class="tdTop">设备编号 / Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="equtypeId" value="${Equ_type.equtypeId}"></td>
        </tr>   
        <tr>
            <td class="tdTop">设备图片 / EqutypeImg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom">
           <img alt="" src="${Equ_type.equtypeImg}" style="width: 35px;height: 35px;border-radius: 50%;margin-top: 2.5px">
            <input type="hidden" name="equtypeImg" value="${Equ_type.equtypeImg}">
            <input type="file" class="input1" name="file"  value="${Equ_type.equtypeImg}">             
            </td>
        </tr>   
        <tr>
            <td class="tdTop">设备名称 / EqutypeName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="equtypeName" value="${Equ_type.equtypeName }"></td>
        </tr>   
    </table>
    </form>
</div>
    <div class="bottom2" style="float:left;background-color:white;height:40px;width: 98%;">
          ...
          <div class="fenPage"><a href="#" onclick="updateEqu_type()">提交</a></div>
          <div class="fenPage"><a href="javascript:void(0);" onclick="goBack()">返回</a></div>
          </div>
    </div>
<script type="text/javascript">

function updateEqu_type(){
    ...
    $.ajax({
		...
		type : "post",
		url : '<c:url value="Equi_typeServlet/updateEqu_type" />'  
	}); 
}
function goBack(){
	$.ajax({
