...
<div class="div3">
    ...
    <input type="hidden" name="id" value="${ lcdPovo.id }">
    <table class="table2">
        <tr>
            <td class="tdTop">序号 / number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="labId" value="${ lcdPovo.labId }"></td>
        </tr>   
        <tr>
            <td class="tdTop">房间号 / room&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="labRoom" value="${ lcdPovo.labRoom }"></td>
        </tr>   
        <tr>
            <td class="tdTop">实验室名称 / name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="labName" value="${ lcdPovo.labName }"></td>
        </tr>   
        <tr>
            <td class="tdTop">实验室功能 / use&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="tdBottom"><input type="text" class="input1" name="labUse" value="${ lcdPovo.labUse }"></td>
        </tr>   
        <tr>
            <td class="tdTop">负责人 / user&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="tdBottom"><select name="labUser" class="input1">
							<c:forEach items="${customers}" var="customer">
								<c:choose>
									<c:when test="${customer.custId eq lcdPovo.custId}">
										<option value="${customer.custId}" selected="selected">${customer.custName}</option>
									</c:when>
									<c:otherwise>
            ...
            <td class="tdTop">院系 / department&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="tdBottom"><select name="labDepart" class="input1">
							<c:forEach items="${departs}" var="depart">
								<c:choose>
									<c:when test="${depart.departId eq lcdPovo.departId}">
										<option value="${depart.departId}" selected="selected">${depart.departName}</option>
									</c:when>
									<c:otherwise>
...
function insertLabor(){
    ...
    $.ajax({
		...
		type : "post",
		url : '<c:url value="LaborServlet/updateLabor" />'  
	}); 
}
function goBack(){
	$.ajax({
